...
T.TabButton {
    ...
    width: StylePlugin.dimensions.actionableMiniWidth
    implicitHeight: 24
    y: 4
    ...
    background: Item {
        ...
        InteractiveGradientItem {
            ...
            primaryColor: control.checked ? StylePlugin.palette.greyMidLight :
                            control.pressed ? StylePlugin.palette.primaryMid :
                            control.hovered ? StylePlugin.palette.primaryNormal : StylePlugin.palette.greyDark
